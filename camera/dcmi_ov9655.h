...
//Camera settings, GPIO
#define  TIMEOUT  		2

#define  CAMERA_DATAPORT	GPIOA

#define  CAMERA_PXCLC		GPIO_Pin_9
#define	 CAMERA_PXCLCPORT 	GPIOA
#define  CAMERA_PXCLCCLOCK	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE)

#define  CAMERA_HREF	GPIO_Pin_8
#define  CAMERA_VSYNC	GPIO_Pin_9
#define  CAMERA_PORT	GPIOB
#define  CAMERA_CLOCK	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE)
