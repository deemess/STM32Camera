...
#define  CAMERA_RST_PIN			  GPIO_Pin_9
#define  CAMERA_RST_PORT		  GPIOB

#define  CAMERA_PWR_EN_PIN		GPIO_Pin_8
#define  CAMERA_PWR_EN_PROT		GPIOB
...
/*	uint8_t buff[1];
	...
	if(I2C_Master_BufferWrite(I2C1, buff, 1, Polling, Addr) == Error)
		return 0xFF;
